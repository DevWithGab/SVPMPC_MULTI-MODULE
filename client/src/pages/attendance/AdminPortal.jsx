...
import { 
  ChevronLeft, ChevronRight, Users, Calendar, BarChart3, Settings, 
  QrCode, FileText
} from 'lucide-react';
import { 
  Dashboard, 
...
const AdminPortal = ({ onBack }) => {
  ...
  const menuItems = [
    ...
    { id: 'scanners', label: 'Scanner Stations', icon: QrCode },
          ...
          <div className="flex items-center justify-between">
            {!sidebarCollapsed && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold" style={{ color: '#2D7A3E' }}>Attendance Admin</h2>
        ...
        <div className="p-6">
          ...
          {activeSection === 'settings' && (
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <h2 className="text-xl font-semibold mb-4" style={{ color: '#2D7A3E' }}>Settings</h2>
