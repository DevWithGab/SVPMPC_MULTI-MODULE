    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Manage your attendance profile and settings</p>
        </div>
        ...
        <Card className="lg:col-span-1 border-slate-200/60 shadow-lg shadow-slate-200/40 rounded-[2rem] overflow-hidden bg-white">
          <div className="h-32 bg-coop-green relative">
            <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-md px-3 py-1 rounded-full border border-white/20">
              <p className="text-[8px] font-black text-white uppercase tracking-widest">Active Member</p>
            </div>
          </div>
          <div className="px-8 pb-8 -mt-16 relative z-10 text-center">
            ...
            <h3 className="text-2xl font-black text-slate-950 tracking-tight">{user?.name || 'Member'}</h3>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-1">
              Member ID: {user?.id?.toString().padStart(6, '0') || '000000'}
            </p>
            ...
            <div className="mt-6 space-y-4 text-left">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] font-bold text-slate-700 truncate">{user?.email || 'Not provided'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-slate-50 flex items-center justify-center">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] font-bold text-slate-700">{user?.phone || 'Not provided'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-slate-50 flex items-center justify-center">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] font-bold text-slate-700">January 2023</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border-slate-200/60 shadow-lg shadow-slate-200/40 rounded-[2rem] p-8 bg-white">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-xl font-black text-slate-950 tracking-tight mb-2">Your QR Code</h3>
                <p className="text-slate-500 text-sm font-bold mb-6">Use this QR code for attendance scanning at events.</p>
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-slate-500 font-bold mt-3">ID: {user?.id?.toString().padStart(6, '0') || '000000'}</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="border-slate-200/60 shadow-lg shadow-slate-200/40 rounded-[2rem] overflow-hidden bg-white">
            <CardHeader className="p-8 border-b border-slate-100">
              <CardTitle className="text-xl font-black text-slate-950 tracking-tight">Account Information</CardTitle>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Your attendance system details</p>
            </CardHeader>
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Member Status</p>
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-950">January 15, 2023</p>
                  </div>
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Last Activity</p>
                    <p className="text-sm font-bold text-slate-950">Today, 2:30 PM</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Total Attendance</p>
                    <p className="text-sm font-bold text-slate-950">24 Events</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">QR Code Status</p>
                    <p className="text-sm font-bold text-coop-green">Active & Valid</p>
                  </div>
                </div>
              </div>
            </CardContent>
