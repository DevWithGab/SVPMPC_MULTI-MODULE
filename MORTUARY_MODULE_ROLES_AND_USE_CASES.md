...
| Use Case ID | Use Case Name | Description |
|-------------|---------------|-------------|
| AD-UC-001 | View Admin Dashboard | View comprehensive system statistics and overview |
| AD-UC-002 | Monitor System Health | Track overall fund status and member statistics |
| AD-UC-003 | View Activity Logs | Monitor recent system activities and changes |

### 👥 Member Management
| Use Case ID | Use Case Name | Description |
|-------------|---------------|-------------|
| AD-UC-004 | Add New Member | Register new member to mortuary fund system |
| AD-UC-005 | View All Members | Display complete member directory |
| AD-UC-006 | Search Members | Search members by name, ID, or contact |
| AD-UC-007 | Filter Members by Status | Filter by active/inactive/deceased status |
| AD-UC-008 | Update Member Information | Edit member details (name, contact, status) |
| AD-UC-009 | Delete Member | Remove member from system (with validation) |
| AD-UC-010 | View Member Profile | Display detailed member information |
| AD-UC-011 | Send SMS to Member | Send manual SMS notification to specific member |
| AD-UC-012 | Import Members from CSV | Bulk import members from CSV file |
| AD-UC-013 | Export Members to CSV | Download member list for external use |

### 💵 Contribution Management (Admin Level)
| Use Case ID | Use Case Name | Description |
|-------------|---------------|-------------|
| AD-UC-014 | Record Member Contribution | Manually record contribution payment |
| AD-UC-015 | View All Contributions | Display complete contribution history |
| AD-UC-016 | Search Contributions | Search by member, date, or amount |
| AD-UC-017 | Filter Contributions | Filter by status, date range, or member |
| AD-UC-018 | Verify Pending Contributions | Approve or reject pending contributions |
| AD-UC-019 | Export Contribution Data | Download contribution records |

### 💸 Payout Management
| Use Case ID | Use Case Name | Description |
|-------------|---------------|-------------|
| AD-UC-020 | Record New Payout | Register death benefit payout to beneficiary |
| AD-UC-021 | View All Payouts | Display complete payout history |
| AD-UC-022 | View Payout Details | Display detailed payout information |
| AD-UC-023 | Search Payouts | Search by member, beneficiary, or date |
| AD-UC-024 | Filter Payouts by Date | Filter payouts by date range |
| AD-UC-025 | Export Payout Records | Download payout data for auditing |

### 📈 Reports & Analytics (Admin Level)
| Use Case ID | Use Case Name | Description |
|-------------|---------------|-------------|
| AD-UC-026 | Generate Financial Report | Create comprehensive financial summary |
| AD-UC-027 | Generate Member Statistics | Create member demographic and status report |
| AD-UC-028 | Generate Contribution Analysis | Analyze contribution patterns and trends |
| AD-UC-029 | Generate Payout Summary | Create payout disbursement report |
| AD-UC-030 | Generate Annual Report | Create yearly financial and operational report |
| AD-UC-031 | Export All Reports | Download reports in PDF/CSV format |

### ⚙️ System Settings
| Use Case ID | Use Case Name | Description |
|-------------|---------------|-------------|
| AD-UC-032 | Configure System Settings | Modify system-wide configuration |
| AD-UC-033 | Set Contribution Amount | Define standard contribution amount |
| AD-UC-034 | Set Minimum Balance Threshold | Configure low balance alert threshold |
| AD-UC-035 | Set Deduction Amount | Configure automatic deduction amount |
| AD-UC-036 | Manage Notification Templates | Create/edit SMS notification templates |
...
5. **Custom Message**: Manual SMS from Admin/Treasurer
